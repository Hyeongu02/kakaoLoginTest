...
import com.choongang.frombirth.command.KakaoTokenResponseDto;
...
public class KakaoService {
    ...
    public KakaoUserInfoResponseDto getUserInfo(String accessToken) {
        ...
        System.out.println("[ Kakao Service ] ProfileImageUrl ---> {} "+ userInfo.getKakaoAccount().getProfile().getProfileImageUrl());
